    ...
    <div>
      ...
      {enrollments.length === 0 ? (
        <div className="text-center py-16">
          <p className="text-slate-500 text-sm mb-4">No estas inscrito en ningun curso</p>
          ...
          {enrollments.map(e => (
            <div key={e.id} className="card overflow-hidden">
              <div className="aspect-video bg-slate-100 dark:bg-slate-800">
                {e.course.thumbnail ? <img src={e.course.thumbnail} alt={e.course.title} className="w-full h-full object-cover" /> : null}
              </div>
              <div className="p-4">
